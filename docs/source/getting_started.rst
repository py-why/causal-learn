...
To help users get a quick sense of running time, we conducted a quick benchmarking for some methods. We consider datasets with number of variables from {10, 25, 50, 100} and average degree from {2, 3, 4, 5}. The sample size is 1000. Results are as follows (more results will be updated soon).
