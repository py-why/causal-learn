...
class TestCDNOD(unittest.TestCase):
    ...
    def test_cdnod_domainvary(self):
        ...
        data1 = np.loadtxt(data1_path, skiprows=1)[:50, :]  # Import the file at data_path as data
        data2_path = "TestData/data_linear_2.txt"
        data2 = np.loadtxt(data2_path, skiprows=1)[:50, :]  # Import the file at data_path as data
        data3_path = "TestData/data_linear_3.txt"
        data3 = np.loadtxt(data3_path, skiprows=1)[:50, :]  # Import the file at data_path as data
