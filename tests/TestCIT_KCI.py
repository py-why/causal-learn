...
class TestCIT_KCI(unittest.TestCase):
    ...
    def test_Polynomial(self):
        ...
        cit_CIT = cit.CIT(data=np.hstack((X, X1, Y, Z)), method='kci', kernelX='Polynomial', kernelY='Polynomial',
                          kernelZ='Polynomial')
    ...
    def test_Linear(self):
        ...
        cit_CIT = cit.CIT(data=np.hstack((X, X1, Y, Z)), method='kci', kernelX='Linear', kernelY='Linear',
                          kernelZ='Linear')
